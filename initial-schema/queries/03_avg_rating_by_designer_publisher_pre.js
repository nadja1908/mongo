// Pre-optimized: average rating by designer-publisher pairs
...
printjson({ label: 'avg_rating_by_designer_publisher_pre', totalPairs: pairs.length, top3ByRating, top3ByOwned });
